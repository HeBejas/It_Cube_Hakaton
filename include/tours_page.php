    ...
    <div class="container tours_container">
                ...
                <div class="filters_row">
                    <div class="filters_col">
                        ...
                        <div class="input_wrapper">
                            ...
                            <input id="place_izh" type="checkbox" value="Ижевск">
                        </div>
                        <div class="input_wrapper">
                            <label for="place_vot">Воткинск</label>
                            <input id="place_vot" type="checkbox" value="Воткинск">
                        </div>
                        <div class="input_wrapper">
                            <label for="place_sar">Сарапул</label>
                            <input id="place_sar" type="checkbox" value="Сарапул">
                        </div>
                        <div class="input_wrapper">
                            <label for="place_glz">Глазов</label>
                            <input id="place_glz" type="checkbox" value="Глазов">
                        </div>
                        <div class="input_wrapper">
                            <label for="place_mzh">Можга</label>
                            <input id="place_mzh" type="checkbox" value="Можга">
                        </div>
                        <div class="input_wrapper">
                            <label for="place_cum">Камбарка</label>
                            <input id="place_cum" type="checkbox" value="Камбарка">
                        </div>
                    </div>
                    <div class="filters_col">
        ...
        <div class="tours_list">
            <div class="tour">
                ...
                <img src="media/images/natsionalnyy-park.png" alt="">
                <div class="tour_info">
